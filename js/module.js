(function($) {
  $(function() {
    ...
    initPowerRange(iconRange, icoRangeOpts);
    initPowerRange(fontRange, fontRangeOpts);
    ...
    var bgColorSelector = new initColorPicker(bgColorSelectorElem,
      bgColorSelectorOpts);
    var iconColorSelector = new initColorPicker(iconColorSelectorElem,
      iconColorSelectorOpts);
